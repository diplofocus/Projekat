...
int main()
{
	...
	//k3
            ...
            particle[j].a3.x += -G * particle[i].m * (particle[j].r3.x - particle[i].r3.x) / cube(sqrt(sqr(particle[i].r2.x - particle[j].r2.x) + sqr(particle[i].r2.y - particle[j].r2.x)));
            particle[j].a3.x += -G * particle[i].m * (particle[j].r3.y - particle[i].r3.y) / cube(sqrt(sqr(particle[i].r2.x - particle[j].r2.y) + sqr(particle[i].r2.y - particle[j].r2.y)));
	        }
	}
